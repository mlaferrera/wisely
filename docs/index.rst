.. wisely documentation master file, created by
   sphinx-quickstart on Mon Mar 19 12:29:35 2018.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to wisely's documentation!
==================================
...
simplcity, this documentation assumes that you have already `created a GCS bucket <https://cloud.google.com/storage/docs/creating-buckets>`_
for secret storage, and have also `created a KMS keyring and key <https://cloud.google.com/kms/docs/creating-keys`_.
...
secret_path
    Filename of secret file in GCS

keyring_id
    KMS keyring name

crypto_id
    KMS key name within the specified keyring

location_id
    Google Cloud zone the keyring is located in

bucket_name
    GCS bucket name to store secrets
...
----------------
    ...
    detailed above as environment variables::
        ...
        wise = Wisley(project_id=project_id, secret_path=secret_path, keyring_id=keyring_id,
